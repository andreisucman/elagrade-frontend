...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>Privacy | Elagrade</title>
        <meta name="description" content={"Elagrade - Privacy Policy"} />
      </Head>
      <div className={styles.container}>
        <div className={styles.wrapper}>
          ...
          <p>
            ...
            collection, use, and protection of personal information we gather
            from users of our range of free applications (&quot;Services&quot;).
          </p>
          ...
          <ul className={styles.list}>
            ...
            <li>
              - For communication regarding updates, security alerts, and
              support messages.
            </li>
            <li>
          ...
          <p>
            We rely on technology and services supplied by our partners to
            operate our Services. Therefore, we may share your information with
            these partners to the extent necessary for the provision and
            improvement of the Services. We ensure that our partners are
            committed to protecting your information and use it solely for the
          ...
          <ul className={styles.list}>
            <li>
              - Access and receive a copy of the personal data we hold about
              them.
            </li>
