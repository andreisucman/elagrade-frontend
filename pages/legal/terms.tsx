  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <p>
          elagrade.com is a publishing company that offers their products to the
          user in the form of digital books.
        </p>
        ...
        <p>
          ...
          rights. (b) You grant the elagrade.com a worldwide, royalty-free, and
          non-exclusive license to reproduce, modify, distribute, and publish
          the content you upload for the sole purpose of providing the
          Site&quot;s services.
        </p>
        ...
        <p>
          ...
          available&quot; basis. elagrade.com makes no warranties, expressed or
          implied, regarding the accuracy, reliability, or completeness of the
          Site&quot;s content. (b) elagrade.com does not guarantee job placement
          or the suitability of any job listing.
        </p>

        <h3>Indemnification</h3>
        <p>
          You agree to indemnify and hold elagrade.com, its affiliates,
          officers, and employees, harmless from any claim or demand due to your
          breach of these Terms or the documents it incorporates by reference,
        ...
        <p>
          ...
          Continued use of the Site after changes to the Terms constitutes your
