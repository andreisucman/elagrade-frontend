export const faqs = [
  ...
  },
  {
    ...
    answer:
      "We use AI to grade your papers with your personal grading style. Because AI is affordable, we're able to charge you the cost only, plus some markup to make it meaningful for us. That's said, our AI is based on GPT4 model, which is not to be confused with the free GPT3 model used in ChatGPT. The model we use is significantly bigger and more intelligent which you can notice if you compare the results.",
  },
  {
