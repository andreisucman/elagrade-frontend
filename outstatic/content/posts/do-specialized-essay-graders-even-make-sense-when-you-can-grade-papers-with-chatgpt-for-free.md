...
Have you tried grading papers with ChatGPT or Google Gemini? Both have free plans with unlimited quota.
...
In fact, this problem is not generally known to people outside of the AI engineering world, because it's not officially accepted. 

The problem is that the AI is getting more stupid; the free models in particular.
...
Later introduced the premium GPT4 version was even better. It was so smart that it gave the impression that you were talking to a real person.
...
After securing a huge user base and making their model a name, OpenAI pursued another clever strategy. They promised their users to make models faster and prices for the API (programmatic access) lower.

A great promise isn't it? Better service, cheaper. Sounds too good to be true.

And as experience tells, things that sound too good to be true usually are too good to be true. And so it turned out that these benefits are going to happen at the expense of the service quality.

But here's the catch.

The company hasn't publicly accepted that shift. 

In fact this is one of the most ignored topics on the forum. Neither did they change the names of the models, or lowered the price to now much less capable premium model for the general public.
...
Yet, this truth is not publicly accepted. 

That's why it humbly takes it's place somewhere in-between the annunaki and the golden billion conspiracy theories.

And the only way to uncover the speculation is to compare the statistics of the old results from the past with the new ones. Something the developers have done. Here is a thread on the OpenAI forum where [***tens of developers complain about the models getting stupider***](https://community.openai.com/t/why-chatgpt-4-0-is-getting-stupider-and-stupider/590741) with time.

### Grading papers with ChatGPT now takes more skill

Now, you probably see where I'm getting at. 

With the models becoming more stupid, getting satisfactory results is starting to take more time and skill.
...
Just like happens with humans, the lower is the intelligence of the person you're talking to, the more carefully you have to choose your words.

Prompt engineering is a fun activity. Especially for people who love thinking. It makes you pay attention to the words and often even discover their true meaning.

But sadly, it's hard.

Therefore, if you intend to grade a paper with over 1k words with ChatGPT, your best bet would be to subscribe to their premium plan, which costs $20 / month because the free model is just not capable of grasping everything without leaving much of the context out.

### How bad is the free ChatGPT model for marking papers?

But how bad is the free model?

Because 20$ is good money in the current economy, and the premium model has a limited quota of 50 messages every 3 hours, why not just use the free version but give it a lot more follow up instructions?
...
Time this and multiply by your hourly wage and you'll get how much you're losing.

That's why using a free AI model is not a good option unless you're very new to it and just want to see how it feels.

And so, if you're planning to get real value out of the AI essay grading a better choice would be to go with the premium version. The amount of effort-and-time-dollars this will save you will outweigh the 20$ subscription fee pretty quickly.

Or there is one more popular solution, which I'm going to reveal in a moment.
...
Consequently, using it's free version for grading homework is not a good idea because of the significant loss of time and effort on giving additional instructions, and a better option would be using a premium model that costs 20$ / month.

But there's one more alternative that is best in my opinion - using specialized AI essay graders.

For obvious reasons, I'll be talking about Elagrade here, but you can probably extend the same arguments to other software too.
...
It reads selectively, especially when the text is long which means that you have to become good at writing your prompt in such a way that it retains its meaning even if it's not read entirely.

One of the techniques for achieving this is duplicating the most important parts of your prompt. And there are others.

But still, overall, getting good results with one-shot grading is difficult and unpredictable, and therefore, a better option would be to ask follow-up questions.
...
The AI is searching and therefore going deeper, just like we, humans do.

Yet as we've already discussed, asking follow-up questions takes time and effort, which can negate the benefits you're getting from using the AI.

The good news however, is that this process can be automated.
...
All of this is in addition to other benefits such as the free renewable monthly quota, not having to retype your rubric, prepaid pricing, consistent grades over multiple runs, bulk grading of up to 100 papers at a time, and the results available in a single Word document report.
...
### Specialized essay graders are best, premium LLMs are good, and the free bots are for sadomasochists
...
Therefore, it's better to use the premium version of the AI as it's much more capable than the free model.

That said, you will still have to guide it, albeit less, and copy-paste the output, dealing with inconsistent formatting, and risking mixing up the results.
